...
<body>
    ...
    if (isset($_POST['supprimer'])) {
        $idsalle = $_GET['s'];
        $querysupp = $connexion->exec("DELETE FROM salle WHERE id_salle =' $idsalle  '");
        //Echo "La salle ayant pour id  = " . $idsalle . " a bien été supprimée";
        alert("La salle ayant pour id  = " . $idsalle . " a bien été supprimée");
...
//INSERT INTO `salle` (`id_salle`, `titre`, `description`, `photo`, `pays`, `ville`, `adresse`, `cp`, `capacite`, `categorie`) VALUES (NULL, 'Orange', 'Salle des DIW 2019', 'aucune', 'France', 'Paris', '14 rue gustave Eiffel', '78180', '25', 'Formation'); 
        ...
        $query = $connexion->exec("INSERT INTO `salle` (`id_salle`, `titre`, `description`, `photo`, `pays`, `ville`, `adresse`, `cp`, `capacite`, `categorie`) "
